...
/*This is to enumerate large maximal bicliques only with minimum size threshold*/
...
public class LMBC_large {
	 ...
	 * @throws Exception
	 */
	public LMBC_large(UndirectedGraph<String, DefaultEdge> G, Bipartition bp) throws Exception{
		...
		if(bp.getL().size() < bp.getR().size()){
			tail_X = new HashSet<>(bp.getL());
			gamma_X = new HashSet<>(bp.getR());
		}
		else{
			tail_X = new HashSet<>(bp.getR());
			gamma_X = new HashSet<>(bp.getL());
		}
	 ...
	 * @throws Exception
	 */
	public LMBC_large(UndirectedGraph<String, DefaultEdge> G) throws Exception{
	...
	public static void main(String[] args) throws Exception {
		...
		int debug = Integer.parseInt(args[4]);	// Check for debugging options
